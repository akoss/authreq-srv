...
class ApnsPHP_Message
{
	...
	protected $_sSubtitle; /**< @type string Alert subtitle to display to the user. */
	...
	/**
	 * Set the alert subtitle to display to the user.  This will be the second BOLD text on the top of the push message. 
	 *
	 * @param  $sSubtitle @type string An alertsubtitle to display to the user.
	 */
	...
	/**
	 * Get the alert subtitle to display to the user.
	 *
	 * @return @type string The alert subtitle to display to the user.
	 */
	...
	protected function _getPayload()
	{
		...
		if (isset($this->_sText)) {
		    if (isset($this->_sTitle) && strlen($this->_sTitle) > 0) {
		        ...
		        if (isset($this->_sSubtitle) && strlen($this->_sSubtitle) > 0) {
					$aPayload[self::APPLE_RESERVED_NAMESPACE]['alert']['subtitle'] =  (string)$this->_sSubtitle;
		        }
		    } else {
